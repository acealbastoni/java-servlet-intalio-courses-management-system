...
import com.coursemanagement.hello.FileCopyUtil;
...
public class DownloadPDF extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		FileCopyUtil.copyPdfFilesIfNotExist(getServletContext().getRealPath("/WEB-INF/pdf/"), DBConnection.UPLOAD_FILES_DIRECTORY);
	}
	 ...
	 */
	private void sendFileWithRenamed(HttpServletResponse response, File file, String fileGuid, int moduleID)
			throws IOException {
